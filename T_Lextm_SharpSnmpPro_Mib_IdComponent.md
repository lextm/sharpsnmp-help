...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.IdComponent<br />
...
**C++**<br />
``` C++
public ref class IdComponent
```

**F#**<br />
``` F#
type IdComponent =  class end
```

The IdComponent type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_IdComponent__ctor">IdComponent</a></td><td>
Initializes a new instance of the IdComponent class</td></tr></table>&nbsp;
<a href="#idcomponent-class">Back to Top</a>
