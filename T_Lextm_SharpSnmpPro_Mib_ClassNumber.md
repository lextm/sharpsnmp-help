...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.ClassNumber<br />
...
**C++**<br />
``` C++
public ref class ClassNumber
```

**F#**<br />
``` F#
type ClassNumber =  class end
```

The ClassNumber type exposes the following members.
...
Initializes a new instance of the ClassNumber class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_ClassNumber__ctor">ClassNumber(DefinedValue)</a></td><td>
Initializes a new instance of the ClassNumber class</td></tr></table>&nbsp;
<a href="#classnumber-class">Back to Top</a>
