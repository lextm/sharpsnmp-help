# NotificationTypeMacro Class
 


## Inheritance Hierarchy
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.NotificationTypeMacro<br />
...
**VB**<br />
``` VB
Public Class NotificationTypeMacro
	Implements ISmiType, IConstruct, IEntity, IValidatable
```

**C++**<br />
``` C++
public ref class NotificationTypeMacro : ISmiType, 
	IConstruct, IEntity, IValidatable
```

**F#**<br />
``` F#
type NotificationTypeMacro =  
    class
        interface ISmiType
...
The NotificationTypeMacro type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_NotificationTypeMacro__ctor">NotificationTypeMacro</a></td><td>
Initializes a new instance of the NotificationTypeMacro class</td></tr></table>&nbsp;
<a href="#notificationtypemacro-class">Back to Top</a>
...
Returns a string that represents the current object.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_NotificationTypeMacro_Validate">Validate</a></td><td /></tr></table>&nbsp;
<a href="#notificationtypemacro-class">Back to Top</a>
