...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpLib.Messaging.TrapV1Message<br />
...
**VB**<br />
``` VB
Public NotInheritable Class TrapV1Message
	Implements ISnmpMessage
```

**C++**<br />
``` C++
public ref class TrapV1Message sealed : ISnmpMessage
```
...
Initializes a new instance of the TrapV1Message class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_TrapV1Message__ctor_1">TrapV1Message(VersionCode, IPAddress, OctetString, ObjectIdentifier, GenericCode, Int32, UInt32, IList(Variable))</a></td><td>
Initializes a new instance of the TrapV1Message class</td></tr></table>&nbsp;
<a href="#trapv1message-class">Back to Top</a>

## Properties
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_AgentAddress">AgentAddress</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Community">Community</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Enterprise">Enterprise</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Generic">Generic</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Header">Header</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Parameters">Parameters</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Privacy">Privacy</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Scope">Scope</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Specific">Specific</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_TimeStamp">TimeStamp</a></td><td /></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TrapV1Message_Version">Version</a></td><td /></tr></table>&nbsp;
<a href="#trapv1message-class">Back to Top</a>
