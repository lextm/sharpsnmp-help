# Messenger.NextMessageId Property 
...
**VB**<br />
``` VB
Public Shared ReadOnly Property NextMessageId As Integer
	Get
```
...
``` C++
public:
static property int NextMessageId {
	int get ();
}
```
...
**F#**<br />
``` F#
static member NextMessageId : int with get
