...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.TypeOrValue<br />
...
**C++**<br />
``` C++
public ref class TypeOrValue
```

**F#**<br />
``` F#
type TypeOrValue =  class end
```

The TypeOrValue type exposes the following members.
...
Initializes a new instance of the TypeOrValue class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_TypeOrValue__ctor_1">TypeOrValue(ISmiValue)</a></td><td>
Initializes a new instance of the TypeOrValue class</td></tr></table>&nbsp;
<a href="#typeorvalue-class">Back to Top</a>
