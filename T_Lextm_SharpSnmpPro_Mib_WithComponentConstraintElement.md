...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;<a href="T_Lextm_SharpSnmpPro_Mib_ConstraintElement">Lextm.SharpSnmpPro.Mib.ConstraintElement</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.WithComponentConstraintElement<br />
...
**VB**<br />
``` VB
Public Class WithComponentConstraintElement
	Inherits ConstraintElement
```

**C++**<br />
``` C++
public ref class WithComponentConstraintElement : public ConstraintElement
```

**F#**<br />
``` F#
type WithComponentConstraintElement =  
    class
        inherit ConstraintElement
    end
```

The WithComponentConstraintElement type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_WithComponentConstraintElement__ctor">WithComponentConstraintElement</a></td><td>
Initializes a new instance of the WithComponentConstraintElement class</td></tr></table>&nbsp;
<a href="#withcomponentconstraintelement-class">Back to Top</a>
