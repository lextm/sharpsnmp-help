...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Lextm_SharpSnmpLib_SnmpException">Lextm.SharpSnmpLib.SnmpException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lextm.SharpSnmpLib.Messaging.MessageFactoryException<br />
...
**VB**<br />
``` VB
Public NotInheritable Class MessageFactoryException
	Inherits SnmpException
```

**C++**<br />
``` C++
public ref class MessageFactoryException sealed : public SnmpException
```

**F#**<br />
``` F#
[<SealedAttribute>]
type MessageFactoryException =  
    class
        inherit SnmpException
    end
```

The MessageFactoryException type exposes the following members.
...
Initializes a new instance of the MessageFactoryException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_MessageFactoryException__ctor_1">MessageFactoryException(String)</a></td><td>
Initializes a new instance of the MessageFactoryException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_MessageFactoryException__ctor_2">MessageFactoryException(String, Exception)</a></td><td>
Initializes a new instance of the MessageFactoryException class</td></tr></table>&nbsp;
<a href="#messagefactoryexception-class">Back to Top</a>
...
When overridden in a derived class, returns the <a href="https://docs.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a> that is the root cause of one or more subsequent exceptions.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_MessageFactoryException_GetBytes">GetBytes</a></td><td /></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="https://docs.microsoft.com/dotnet/api/system.object.gethashcode#System_Object_GetHashCode" target="_blank" rel="noopener noreferrer">GetHashCode</a></td><td>
...
Gets the runtime type of the current instance.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_MessageFactoryException_SetBytes">SetBytes</a></td><td /></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_MessageFactoryException_ToString">ToString</a></td><td> (Overrides <a href="M_Lextm_SharpSnmpLib_SnmpException_ToString">SnmpException.ToString()</a>.)</td></tr></table>&nbsp;
<a href="#messagefactoryexception-class">Back to Top</a>
