...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.Validation.CompilerMessage<br />
...
**C++**<br />
``` C++
public ref class CompilerMessage
```

**F#**<br />
``` F#
type CompilerMessage =  class end
```

The CompilerMessage type exposes the following members.
...
Initializes a new instance of the CompilerMessage class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_Validation_CompilerMessage__ctor">CompilerMessage(MessageCategory, String, IToken, String)</a></td><td>
Initializes a new instance of the CompilerMessage class</td></tr></table>&nbsp;
<a href="#compilermessage-class">Back to Top</a>
...
Creates a shallow copy of the current <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_Validation_CompilerMessage_ToString">ToString</a></td><td>
Returns a <a href="https://docs.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a> that represents this instance.
