...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.ObjectTypeMacro<br />
...
public class ObjectTypeMacro : ISmiType, 
	IConstruct, IEntity, IValidatable, IObjectTypeMacro
```

**VB**<br />
``` VB
Public Class ObjectTypeMacro
...
**C++**<br />
``` C++
public ref class ObjectTypeMacro : ISmiType, 
	IConstruct, IEntity, IValidatable, IObjectTypeMacro
```

**F#**<br />
``` F#
type ObjectTypeMacro =  
    class
        interface ISmiType
        interface IConstruct
        interface IEntity
        interface IValidatable
        interface IObjectTypeMacro
    end
```

The ObjectTypeMacro type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_ObjectTypeMacro__ctor">ObjectTypeMacro</a></td><td>
Initializes a new instance of the ObjectTypeMacro class</td></tr></table>&nbsp;
<a href="#objecttypemacro-class">Back to Top</a>
...
Returns a string that represents the current object.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_ObjectTypeMacro_Validate">Validate</a></td><td>
