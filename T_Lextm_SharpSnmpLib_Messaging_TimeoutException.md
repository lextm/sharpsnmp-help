...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;<a href="https://docs.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Lextm_SharpSnmpLib_SnmpException">Lextm.SharpSnmpLib.SnmpException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Lextm_SharpSnmpLib_OperationException">Lextm.SharpSnmpLib.OperationException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lextm.SharpSnmpLib.Messaging.TimeoutException<br />
...
**C++**<br />
``` C++
public ref class TimeoutException sealed : public OperationException
```
...
Initializes a new instance of the TimeoutException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_TimeoutException__ctor_1">TimeoutException(String)</a></td><td>
Initializes a new instance of the TimeoutException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_TimeoutException__ctor_2">TimeoutException(String, Exception)</a></td><td>
Initializes a new instance of the TimeoutException class</td></tr></table>&nbsp;
<a href="#timeoutexception-class">Back to Top</a>
...
Gets the method that throws the current exception.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Lextm_SharpSnmpLib_Messaging_TimeoutException_Timeout">Timeout</a></td><td /></tr></table>&nbsp;
<a href="#timeoutexception-class">Back to Top</a>

## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Static member](media/static.gif "Static member")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_TimeoutException_Create">Create</a></td><td /></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="https://docs.microsoft.com/dotnet/api/system.object.equals#System_Object_Equals_System_Object_" target="_blank" rel="noopener noreferrer">Equals</a></td><td>
...
Gets the runtime type of the current instance.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_TimeoutException_ToString">ToString</a></td><td> (Overrides <a href="M_Lextm_SharpSnmpLib_SnmpException_ToString">SnmpException.ToString()</a>.)</td></tr></table>&nbsp;
<a href="#timeoutexception-class">Back to Top</a>
