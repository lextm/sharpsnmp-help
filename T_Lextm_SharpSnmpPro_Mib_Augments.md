...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.Augments<br />
...
**C++**<br />
``` C++
public ref class Augments
```

**F#**<br />
``` F#
type Augments =  class end
```

The Augments type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_Augments__ctor">Augments</a></td><td>
Initializes a new instance of the Augments class</td></tr></table>&nbsp;
<a href="#augments-class">Back to Top</a>
