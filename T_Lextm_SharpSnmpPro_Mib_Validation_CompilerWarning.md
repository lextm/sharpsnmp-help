...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.Validation.CompilerWarning<br />
...
**C++**<br />
``` C++
public ref class CompilerWarning
```

**F#**<br />
``` F#
type CompilerWarning =  class end
```

The CompilerWarning type exposes the following members.
...
Initializes a new instance of the CompilerWarning class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_Validation_CompilerWarning__ctor">CompilerWarning(WarningCategory, String, IToken, String)</a></td><td>
Initializes a new instance of the CompilerWarning class</td></tr></table>&nbsp;
<a href="#compilerwarning-class">Back to Top</a>
...
Creates a shallow copy of the current <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_Validation_CompilerWarning_ToString">ToString</a></td><td>
