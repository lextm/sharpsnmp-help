...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.AgentCapabilitiesModule<br />
...
**C++**<br />
``` C++
public ref class AgentCapabilitiesModule
```

**F#**<br />
``` F#
type AgentCapabilitiesModule =  class end
```

The AgentCapabilitiesModule type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_AgentCapabilitiesModule__ctor">AgentCapabilitiesModule</a></td><td>
Initializes a new instance of the AgentCapabilitiesModule class</td></tr></table>&nbsp;
<a href="#agentcapabilitiesmodule-class">Back to Top</a>
