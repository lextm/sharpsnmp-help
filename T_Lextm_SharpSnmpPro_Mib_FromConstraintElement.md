...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;<a href="T_Lextm_SharpSnmpPro_Mib_ConstraintElement">Lextm.SharpSnmpPro.Mib.ConstraintElement</a><br />&nbsp;&nbsp;&nbsp;&nbsp;Lextm.SharpSnmpPro.Mib.FromConstraintElement<br />
...
**VB**<br />
``` VB
Public Class FromConstraintElement
	Inherits ConstraintElement
```

**C++**<br />
``` C++
public ref class FromConstraintElement : public ConstraintElement
```

**F#**<br />
``` F#
type FromConstraintElement =  
    class
        inherit ConstraintElement
    end
```

The FromConstraintElement type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpPro_Mib_FromConstraintElement__ctor">FromConstraintElement</a></td><td>
Initializes a new instance of the FromConstraintElement class</td></tr></table>&nbsp;
<a href="#fromconstraintelement-class">Back to Top</a>
