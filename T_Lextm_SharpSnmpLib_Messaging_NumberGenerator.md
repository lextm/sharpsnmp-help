...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpLib.Messaging.NumberGenerator<br />
...
**VB**<br />
``` VB
Public NotInheritable Class NumberGenerator
```

**C++**<br />
``` C++
public ref class NumberGenerator sealed
```

**F#**<br />
``` F#
[<SealedAttribute>]
type NumberGenerator =  class end
```

The NumberGenerator type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_Messaging_NumberGenerator__ctor">NumberGenerator</a></td><td>
Initializes a new instance of the NumberGenerator class</td></tr></table>&nbsp;
<a href="#numbergenerator-class">Back to Top</a>
