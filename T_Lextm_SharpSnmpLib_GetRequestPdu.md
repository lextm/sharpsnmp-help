...
<a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">System.Object</a><br />&nbsp;&nbsp;Lextm.SharpSnmpLib.GetRequestPdu<br />
...
**VB**<br />
``` VB
Public NotInheritable Class GetRequestPdu
	Implements ISnmpPdu, ISnmpData
```

**C++**<br />
``` C++
public ref class GetRequestPdu sealed : ISnmpPdu, 
	ISnmpData
```
...
The GetRequestPdu type exposes the following members.
...
Initializes a new instance of the GetRequestPdu class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_GetRequestPdu__ctor_1">GetRequestPdu(Tuple(Int32, Byte[]), Stream)</a></td><td>
Initializes a new instance of the GetRequestPdu class</td></tr></table>&nbsp;
<a href="#getrequestpdu-class">Back to Top</a>
...
## Methods
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_GetRequestPdu_AppendBytesTo">AppendBytesTo</a></td><td /></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="https://docs.microsoft.com/dotnet/api/system.object.equals#System_Object_Equals_System_Object_" target="_blank" rel="noopener noreferrer">Equals</a></td><td>
...
Gets the <a href="https://docs.microsoft.com/dotnet/api/system.type" target="_blank" rel="noopener noreferrer">Type</a> of the current instance.
 (Inherited from <a href="https://docs.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Lextm_SharpSnmpLib_GetRequestPdu_ToString">ToString</a></td><td> (Overrides <a href="https://docs.microsoft.com/dotnet/api/system.object.tostring#System_Object_ToString" target="_blank" rel="noopener noreferrer">Object.ToString()</a>.)</td></tr></table>&nbsp;
<a href="#getrequestpdu-class">Back to Top</a>
