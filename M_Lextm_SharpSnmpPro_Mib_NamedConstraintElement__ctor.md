# NamedConstraintElement Constructor 
 

Initializes a new instance of the <a href="T_Lextm_SharpSnmpPro_Mib_NamedConstraintElement">NamedConstraintElement</a> class
...
``` F#
new : 
        name : string -> NamedConstraintElement
```
